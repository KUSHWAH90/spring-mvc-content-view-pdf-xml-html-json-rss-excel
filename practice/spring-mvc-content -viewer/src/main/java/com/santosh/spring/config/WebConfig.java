...
import com.santosh.spring.view.StudentExcelViewResolver;
import com.santosh.spring.view.StudentJsonViewResolver;
import com.santosh.spring.view.StudentPdfViewResolver;
import com.santosh.spring.view.StudentRssFeedViewResolver;
import com.santosh.spring.view.StudentXmlViewResolver;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "com.santosh.spring.controller" })
